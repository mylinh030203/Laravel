    ...
    <table class="table search-table-outter">
        ...
        @forelse ($accounts as $item)
            <tr class="align-middle">
                ...
                <th class="align-middle text-center" scope="row">{{$item->username}}</th>
                <th class="align-middle text-center" scope="row">{{$item->password}}</th>
                <td class="align-middle text-center">
                    <span class=" my-1 text-center
                    badge badge-{{$item->getRole->color}}"> {{$item->getRole->role_name}}</span>
                </td>
