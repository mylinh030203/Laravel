...
@section('actions_layout')
    <a href="{{route('admin.type_product.index')}}" class="btn btn-primary btn-sm mr-2 mb-2 mb-lg-0">
        <i class="fa fa-list"></i> List Type Product
    </a>
@endsection
@section('title_card')
    Edit Type Products
...
@section('content_card')
    ...
    <form action="" method="post">
        ...
        <div class="form-group my-2">
            ...
            <input type="description" class="form-control" id="description" name="description" placeholder="description" value="{{$typeProduct->description}}" >
            @error('description')
            <span class="text-bold text-italic text-danger">{{$message}}</span>
            @enderror
        </div>
