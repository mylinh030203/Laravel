...
@section('actions_layout')
    @if (auth()->user()->id == $user->id)
        <a href="{{ route('user.profile.showedit') }}/{{ auth()->user()->id }}"
                ...
                <div class="col-lg-4">
                    <div class="card mb-4">
                        <div class="card-body text-center">
                            <img src="{{ url($user->URL) }}" alt="avatar" class="rounded-circle img-fluid"
                                style="width: 150px;">
                            <h5 class="my-3">{{ $user->getAccount->username }}</h5>
                            <h6><span
                                    class="badge badge-{{ $user->getAccount->getRole->color }} mx-1">{{ $user->getAccount->getRole->role_name }}</span>{{ $user->getAccount->getRole->description }}
                            </h6>
