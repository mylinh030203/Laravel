                                ...
                                @foreach ($cart as $item)
                                    <tr>
                                        <td class="cart_product_img">
                                            <a href="#"><img class="sm-product" src="{{ url($item->getProduct->URL) }}"
                                                    alt="Product"></a>
                                        </td>
                                        ...
                                        <td class="price">
                                            <span>{{ number_format($item->getProduct->price * $item->quantity, 0, '', ',') }}
                                                VND</span>
                                        </td>
                ...
                <div class="col-12 col-lg-4">
                    <form class="cart-summary" method="post" action="{{ route('user.order.create') }}">
                        ...
                        <ul class="summary-table">
                            ...
                            <li><span>Total Money:</span><input type="hidden" name="total_price"
                                    value="{{ $totalMoney }}"> <span>{{ number_format($totalMoney, 0, '', ',') }}
                                    VND</span></li>
                        </ul>
                        @if ($cart->count() > 0)
