...
<body>
    ...
    <body data-new-gr-c-s-check-loaded="14.1079.0" data-gr-ext-installed="">
        <form method="post" action="">
            ...
            <div class="svgContainer">
                ...
                <g class="body">
                    ...
                    <path class="bodyBGnormal" stroke="#3A5E77" stroke-width="2.5" stroke-linecap="round" stroke-linejoinn="round" fill="#FFFFFF" d="M200,158.5c0-20.2-14.8-36.5-35-36.5h-14.9V72.8c0-27.4-21.7-50.4-49.1-50.8c-28-0.5-50.9,22.1-50.9,50v50 H35.8C16,122,0,138,0,157.8L0,213h200L200,158.5z" data-original="M200,158.5c0-20.2-14.8-36.5-35-36.5h-14.9V72.8c0-27.4-21.7-50.4-49.1-50.8c-28-0.5-50.9,22.1-50.9,50v50 H35.8C16,122,0,138,0,157.8L0,213h200L200,158.5z"></path>
                ...
                <g class="earR">
                    <g class="outerEar" data-svg-origin="141.5 71.5" transform="matrix(1,0,0,1,0,0)">
                    ...
                    <g class="earHair" data-svg-origin="134 62.79999923706055" transform="matrix(1,0,0,1,0,0)">
                ...
                <g class="eyeL" data-svg-origin="85.5 78.5" transform="matrix(0.65,0,0,0.65,29.847614999999998,27.397615000000002)" style="transform-origin: 0px 0px 0px;">
                    <circle cx="85.5" cy="78.5" r="3.5" fill="#3a5e77"></circle>
                    <circle cx="84" cy="76" r="1" fill="#fff"></circle>
                </g>
                <g class="eyeR" data-svg-origin="114.5 78.5" transform="matrix(0.65,0,0,0.65,39.997615,27.397615000000002)" style="transform-origin: 0px 0px 0px;">
                    <circle cx="114.5" cy="78.5" r="3.5" fill="#3a5e77"></circle>
                    <circle cx="113" cy="76" r="1" fill="#fff"></circle>
                </g>
                <g class="mouth" data-svg-origin="100 103.4000015258789" transform="matrix(1,0,0,1,0,0)" style="transform-origin: 0px 0px 0px;">
                ...
                <path class="nose" d="M97.7 79.9h4.7c1.9 0 3 2.2 1.9 3.7l-2.3 3.3c-.9 1.3-2.9 1.3-3.8 0l-2.3-3.3c-1.3-1.6-.2-3.7 1.8-3.7z" fill="#3a5e77" data-svg-origin="100.0374870300293 83.88750076293945" transform="matrix(0.99984,-0.01777,0.01777,0.99984,-1.4750883130837593,1.7911631908879144)" style="transform-origin: 0px 0px 0px;"></path>
                <g class="arms" clip-path="url(#armMask)">
                    <g class="armL" style="visibility: hidden; transform-origin: 0px 0px 0px;" data-svg-origin="1.2000000476837158 47.20000076293945" transform="matrix(-0.25881,0.96592,-0.96592,-0.25881,-45.89771734806486,278.25714885163586)">
                        ...
                        <g class="twoFingers" data-svg-origin="158.3000030517578 86.80000305175781" transform="matrix(0.86602,0.49999,-0.49999,0.86602,55.60818051566028,-69.52100616551013)" style="transform-origin: 0px 0px 0px;">
                    ...
                    <g class="armR" style="visibility: hidden; transform-origin: 0px 0px 0px;" data-svg-origin="385.5 47.03531265258789" transform="matrix(-0.25881,-0.96592,0.96592,-0.25881,346.84211864830615,651.5733533938651)">
            ...
            <div class="inputGroup inputGroup1 focusWithText">
                ...
                <input type="text" id="loginEmail" maxlength="254" class=" is-invalid " name="username" value="" required="">
                <p class="helper helper1">havana</p>

            </div>

            <div class="inputGroup inputGroup1 focusWithText">
                <label for="loginEmail" id="loginEmailLabel">Email</label>
                <input type="email" id="loginEmail" maxlength="254" class=" is-invalid " name="email" value="" required="">
            ...
            <div class="inputGroup inputGroup2">
                ...
                <input type="password" id="loginPassword" class="" name="password" required="">
            ...
            <div class="inputGroup inputGroup2">
                <label for="loginPassword" id="loginPasswordLabel">Re-Password</label>

                <input type="password" id="loginPassword" class="" name="rePassword" required="">
                @error('rePassword')
        ...
        <script type="text/javascript">
            $(".alert-message").fadeTo(1500, 0.1).slideUp(500, function() {
    ...
    <!-- partial -->
    <script src='https://urjadeveloper.com/backend/login/tweenMax.min.js'></script>
    <script src='https://urjadeveloper.com/backend/login/morphsvg.js'></script>
    <script src='https://cdnjs.cloudflare.com/ajax/libs/jquery/3.6.1/jquery.min.js'></script>
    <script src="{{asset('/admin/assets/js/scriptLogin.js')}}"></script>
